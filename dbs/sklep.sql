...
--
-- Host: 127.0.0.1
-- Czas generowania: 16 Maj 2021, 15:58
...
(1, 'Toshiba', 'P300', 1024, 'HDD', 'SATA III', NULL, 170, 170, 175, 0, 'disk/toshibap300.jpg'),
...
(4, 'Samsung', 'SATA SSD 860 EVO', 500, 'SSD', 'SATA III', 'TLC', 550, 520, 299, 153, 'disk/Samsung 860 EVO.jpg'),
(5, 'Seagate ', 'BARRACUDA ', 2048, 'HDD', 'SATA III', NULL, 210, 210, 239, 39, 'disk/Seagate BarraCuda.jpg'),
(6, 'WD', 'BLUE', 1024, 'HDD', 'SATA III', NULL, 155, 150, 219, 85, 'disk/WD BLUE.jpg'),
(7, 'GOODRAM ', 'IRDM PRO', 512, 'SSD', 'SATA III', 'TLC', 555, 540, 319, 27, 'disk/GoodRam IRDM PRO.jpg'),
(8, 'ADATA ', 'XPG SX8200 Pro', 512, 'SSD', 'PCI Express x4 NVMe', NULL, 3500, 2300, 312, 23, 'disk/Adata XPG SX8200 Pro.jpg'),
(9, 'SAMSUNG ', '870 Qvo', 1024, 'SSD', 'SATA III', 'QLC', 560, 530, 449, 56, 'disk/Samsung 870 Qvo.png'),
...
INSERT INTO `karty_graficzne` (`id_GPU`, `firma`, `model`, `pamiec`, `rodzaj_pamieci`, `zlacza`, `TDP`, `rdzenie_CUDA`, `cena`, `ilosc_sztuk`, `img_path`) VALUES
(1, 'Nvidia', 'GTX 1650', 4, 'GDDR6', 'HDMI, DisplayPort', 75, 896, 759, 10, 'gpu/gtx1650.jpg'),
(2, 'AMD', 'MSI RADEON RX 5500 XT MECH OC', 4, 'GDDR6', 'HDMI, DisplayPort', 130, NULL, 889, 0, 'gpu/rx5500xt.jpg'),
(3, 'Nvidia', 'Zotac GeForce RTX 2060 ', 6, 'GDDR6', 'HDMI, DisplayPort', 160, 1920, 1459, 69, 'gpu/rtx2060.jpg'),
(4, 'MSI', 'RTX 2070 SUPER GAMING X TRIO', 8, 'GDDR6', 'HDMI, DisplayPort', 215, 2560, 2459, 54, 'gpu/rtx2070.jpg'),
(5, 'Nvidia', 'KFA2 GeForce RTX 3090 HOF', 24, 'GDDR6X', 'HDMI, DisplayPort ', 350, 10496, 15199, 7, 'gpu/rtx3090.jpg'),
(6, 'Nvidia', 'PNY Quadro RTX 4000', 8, 'GDDR6', 'DisplayPort,  USB-C (VirtualLink)', 125, 2304, 4899, 12, 'gpu/rtx4000.png'),
(7, 'AMD', 'XFX Radeon RX 580 GTS XXX Edition OC+', 8, 'GDDR5', 'HDMI,  DVI-D, DisplayPort ', 185, NULL, 2949, 52, 'gpu/rx580.jpg'),
(9, 'AMD', 'MSI Radeon RX 6700 XT MECH 2X', 12, 'GDDR6', 'HDMI, DisplayPort ', 230, NULL, 4999, 4, 'gpu/rx6700xt.png');
...
(1, 'Jan', 'Kowalski', NULL, 'jkowalski@gmail.com', 'jkowal', '$2y$10$NIqZrTJAkePk.2Q1v3pgZe8aSpMV1D.M49m0.V77iLpUX8wNV6JOW', NULL, NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Zastąpiona struktura widoku `koszyk`
-- (Zobacz poniżej rzeczywisty widok)
--
CREATE TABLE `koszyk` (
`id_produkty` int(11)
...
,`nazwisko` varchar(25)
,`telefon` int(9)
,`cena_zamowienia` int(11)
,`Producent Dysku` varchar(25)
,`Model Dysku` varchar(25)
,`Producent Karty Graficznej` varchar(25)
,`Model Karty Graficznej` varchar(40)
,`Producent Obudowy` varchar(25)
,`Model Obudowy` varchar(25)
,`Producent Płyty Głównej` varchar(25)
,`Model Płyty Głównej` varchar(25)
,`Producent Procesoru` varchar(25)
,`Model Procesoru` varchar(25)
,`Producent RAMu` varchar(25)
,`Model RAMu` varchar(25)
,`Producent Zasilacza` varchar(25)
,`Model Zasilacza` varchar(25)
);
...
(1, 'iBOX', 'VESTA S07', 'Middle Tower', 'ATX, m-ATX', 0, 0, 5, 79, 75, 'case/iBox VESTA S07.jpg'),
(2, 'Zalman', 'ZM-T3', 'Mini Tower', 'm-ATX, Mini-ITX', 0, 1, 6, 119, 89, 'case/Zalman ZM-T3.jpg'),
...
(5, 'SilentiumPC', 'Armis AR7', 'Middle Tower', 'ATX, microATX, Mini-ITX', 0, 1, 11, 359, 12, 'case/Silentium Armis AR7.jpg'),
(6, 'be quiet!', 'Pure Base 600', 'Middle Tower', 'ATX, microATX, Mini-ITX', 0, 1, 13, 429, 17, 'case/be quiet Pure Base 600.jpg'),
(7, 'Genesis ', 'TITAN 700', 'Middle Tower', 'ATX, microATX, Mini-ITX', 1, 1, 4, 169, 32, 'case/genesis TITAN 700.jpg'),
(8, 'Thermaltake ', 'Core W100', 'Super Tower', 'Mini-ITX,XL-ATX,EATX,ATX', 0, 0, 13, 1549, 3, 'case/thermaltake Core W100.jpg'),
(9, 'Thermaltake ', 'Core P3 Curved Edition', 'Open-Air Tower', 'ATX, microATX, Mini-ITX', 0, 0, 4, 879, 6, 'case/thermaltake Core P3 Curved Edition.jpg');
...
(1, 'MSI', 'B450 TOMAHAWK MAX', 'AM4', 4, 4, 'ATX', 589, 122, 'mobo/MSI B450 TOMAHAWK MAX.png'),
(2, 'Gigabyte ', 'B450M S2H', 'AM4', 3, 2, 'uATX', 329, 123, 'mobo/Gigabyte B450M S2H.jpg'),
(3, 'MSI', 'B450M-A PRO MAX', 'AM4', 2, 2, 'mATX', 359, 123, 'mobo/Msi B450M-A PRO MAX.jpg'),
(4, 'MSI', 'B460M-A PRO', '1200', 2, 2, 'uATX', 319, 123, 'mobo/Msi B460M-A PRO.jpg'),
...
(8, 'Gigabyte ', 'B365M D3H', '1151', 3, 4, 'mATX', 379, 17, 'mobo/Gigabyte B365M D3H.jpg'),
...
INSERT INTO `procesory` (`id_CPU`, `firma`, `model`, `socket`, `taktowanie`, `ilosc_rdzeni`, `chlodzenie_box`, `odblokowany_mnoznik`, `cena`, `ilosc_sztuk`, `img_path`) VALUES
(1, 'Intel ', 'i5-10400F', '1200', 2.9, 6, 1, 0, 719, 31, 'cpu/i5-10400F.jpg'),
(2, 'Intel ', 'i5-10400', '1200', 2.9, 6, 1, 0, 799, 123, 'cpu/i5-10400.jpg'),
(3, 'Intel ', 'i5-10600', '1200', 3.3, 6, 1, 0, 1049, 321, 'cpu/i5-10600.jpg'),
(4, 'Intel', 'i5-9400F', '1151', 2.9, 6, 1, 0, 699, 13, 'cpu/i5-9400F.jpg'),
(5, 'AMD ', 'Ryzen 5 3600', 'AM4', 3.6, 6, 1, 1, 869, 47, 'cpu/Ryzen 5 3600.jpg'),
(6, 'AMD ', 'Ryzen 5 5600X', 'AM4', 3.7, 6, 1, 1, 1449, 23, 'cpu/Ryzen 5 5600X.jpg'),
(7, 'AMD ', 'Ryzen 5 3400G', 'AM4', 3.7, 4, 1, 1, 879, 12, 'cpu/Ryzen 5 3400G.png'),
(8, 'AMD ', 'Ryzen 7 3800X', 'AM4', 3.9, 8, 1, 1, 1399, 26, 'cpu/Ryzen 7 3800X.png'),
(9, 'Intel', 'i7-9700F', '1151', 3, 8, 1, 0, 1179, 12, 'cpu/i7-9700F.jpg');
...
INSERT INTO `produkty` (`id_produkty`, `id_CPU`, `id_GPU`, `id_RAM`, `id_dysk`, `id_MOBO`, `id_PSU`, `id_obudowa`) VALUES
(1, 1, 2, 1, 2, 1, 2, 2),
(2, 2, 2, 1, 1, 2, 2, 1),
(3, 4, 3, 4, 3, 4, 3, 4),
(4, 3, 4, 3, 4, 3, 4, 3),
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `ilosc_dyski` BEFORE INSERT ON `produkty` FOR EACH ROW BEGIN
IF((SELECT ilosc_sztuk FROM dyski WHERE id_dysk = new.id_dysk) < 1) THEN
	SIGNAL SQLSTATE '45000'
	SET MESSAGE_TEXT = 'Brak dyskow';
ELSE
	UPDATE dyski
	SET dyski.ilosc_sztuk = (dyski.ilosc_sztuk - 1)
	WHERE id_dysk = new.id_dysk;
END IF;
END
$$
DELIMITER ;
...
INSERT INTO `ram` (`id_RAM`, `firma`, `model`, `rodzaj_pamieci`, `pojemnosci`, `taktowanie`, `opoznienie`, `cena`, `ilosc_sztuk`, `img_path`) VALUES
(1, 'GOODRAM ', 'IRDM X Black', 'DDR4', 4, 3000, 16, 87, 22, 'ram/GoodRam IRDM X Black.jpg'),
(2, 'PNY ', 'Desktop Memory', 'DDR4', 8, 2666, 19, 139, 234, 'ram/PNY Desktop Memory.jpg'),
(3, 'HyperX', 'Fury Black', 'DDR3', 16, 1600, 10, 355, 6666, 'ram/HyperX Fury Black.jpg'),
(4, 'G.SKILL', 'RipjawsX', 'DDR3', 8, 1600, 9, 229, 123, 'ram/G.Skill RipjawsX.jpg'),
(5, 'Corsair ', 'Vengeance', 'DDR4 SODIM', 16, 2400, 16, 339, 12, 'ram/Corsair Vengeance SODIMM.jpg'),
(6, 'HyperX', 'Predator RGB', 'DDR4', 16, 3200, 16, 479, 37, 'ram/HyperX Predator RGB.png'),
(7, 'HyperX ', 'Fury White', 'DDR3', 4, 1600, 10, 164, 51, 'ram/HyperX Fury White.jpg'),
(8, 'G.SKILL', 'Trident Z RGB LED', 'DDR4', 16, 3000, 16, 549, 58, 'ram/G.Skill Trident Z RGB LED.png'),
(9, 'Crucial ', 'Ballistix Black', 'DDR4', 16, 3200, 16, 419, 33, 'ram/Crucial Ballistix Black.jpg'),
(10, 'Patriot ', 'Viper 4', 'DDR4', 16, 3000, 16, 419, 43, 'ram/Patriot Viper 4.jpg');
...
(1, 1, 1, '2020-11-01', 1729, '2020-11-09', 1, 'Brak'),
(2, 2, 2, '2020-10-31', 1923, '2020-11-03', 1, 'Brak'),
(3, 3, 3, '2020-11-09', 4123, '2020-11-17', 1, 'Brak'),
(4, 4, 4, '2020-11-25', 7412, '2020-11-11', 0, 'Przypiąć linką');
...
(1, 'SilentiumPC ', 'Elementum E2 ', 550, 88, '80 PLUS', 0, 179, 0, 'psu/SilentiumPC Elementum E2.jpg'),
(2, 'Cooler Master', 'MWE V2', 500, 85, '80 PLUS', 0, 199, 0, 'psu/Cooler Master MWE V2 500.jpg'),
(3, 'SilentiumPC', 'Vero L3', 600, 80, 'Bronze', 0, 239, 121, 'psu/SilentiumPC Vero L3.png'),
(4, 'Corsair', 'CV', 550, 80, 'Bronze', 0, 229, 0, 'psu/Corsair CV550.png'),
(5, 'iBOX ', 'AURORA', 500, 0, NULL, 0, 118, 12, 'psu/iBox AURORA.jpg'),
(6, 'ASUS', 'ROG Thor', 850, 92, '80 PLUS Platinum', 1, 1169, 42, 'psu/Asus ROG Thor 850w.jpg'),
(7, 'be quiet!', 'System Power 9', 600, 89, '80 PLUS Bronze', 0, 299, 36, 'psu/be quiet System Power 9.jpg'),
(8, 'Cooler Master', 'MWE Gold-V2', 750, 90, '80 PLUS Gold', 1, 479, 34, 'psu/Cooler Master MWE Gold-V2.jpg'),
(9, 'be quiet!', 'Straight Power 11 ', 750, 94, '80 PLUS Gold', 1, 669, 42, 'psu/be quiet Straight Power 11.jpg'),
(10, 'Corsair', 'CX750F RGB', 750, 87, '80 PLUS Bronze', 1, 429, 23, 'psu/Corsair CX750F RGB.jpg');
...
--
-- Struktura widoku `koszyk`
--
DROP TABLE IF EXISTS `koszyk`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `koszyk`  AS SELECT `produkty`.`id_produkty` AS `id_produkty`, `klienci`.`imie` AS `imie`, `klienci`.`nazwisko` AS `nazwisko`, `klienci`.`telefon` AS `telefon`, `zamowienia`.`cena_zamowienia` AS `cena_zamowienia`, `dyski`.`firma` AS `Producent Dysku`, `dyski`.`model` AS `Model Dysku`, `karty_graficzne`.`firma` AS `Producent Karty Graficznej`, `karty_graficzne`.`model` AS `Model Karty Graficznej`, `obudowy`.`firma` AS `Producent Obudowy`, `obudowy`.`model` AS `Model Obudowy`, `plyty_glowne`.`firma` AS `Producent Płyty Głównej`, `plyty_glowne`.`model` AS `Model Płyty Głównej`, `procesory`.`firma` AS `Producent Procesoru`, `procesory`.`model` AS `Model Procesoru`, `ram`.`firma` AS `Producent RAMu`, `ram`.`model` AS `Model RAMu`, `zasilacze`.`firma` AS `Producent Zasilacza`, `zasilacze`.`model` AS `Model Zasilacza` FROM (((((((((`produkty` join `klienci`) join `zamowienia`) join `dyski`) join `karty_graficzne`) join `obudowy`) join `plyty_glowne`) join `procesory`) join `ram`) join `zasilacze`) WHERE `produkty`.`id_CPU` = `procesory`.`id_CPU` AND `produkty`.`id_GPU` = `karty_graficzne`.`id_GPU` AND `produkty`.`id_RAM` = `ram`.`id_RAM` AND `produkty`.`id_dysk` = `dyski`.`id_dysk` AND `produkty`.`id_MOBO` = `plyty_glowne`.`id_MOBO` AND `produkty`.`id_PSU` = `zasilacze`.`id_PSU` AND `produkty`.`id_obudowa` = `obudowy`.`id_obudowa` AND `produkty`.`id_produkty` = `zamowienia`.`id_produkty` AND `zamowienia`.`id_klienta` = `klienci`.`id_klienta` ;
